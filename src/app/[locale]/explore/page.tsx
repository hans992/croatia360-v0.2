...
const regionsData: Region[] = [
  {
    ...
    imageUrl: `${gcsBaseUrl}regions/slavonija/Slavonija_Card.jpg`, // Suggesting a specific card image
    color1: '#FFD700', // Gold
  ...
  },
  {
    ...
    imageUrl: `${gcsBaseUrl}regions/kvarner/Kvarner_Card.jpg`, // Ensure this image exists
    color1: '#009688', // Teal
...
export default function ExplorePage() {
  ...
  const recommendations: Recommendation[] = [
    { id: "hotel_opatija", typeKey: "recommendation_type_accommodation", nameKey: "recommendation_opatija_hotel_name", locationKey: "recommendation_opatija_hotel_location", descriptionKey: "recommendation_opatija_hotel_description", rating: 4.9, reviews: 320, priceRaw: "€250 / noć", priceCategory: "€€€€", tagsKeys: ["tag_spa", "tag_pool", "tag_restaurant"], imageUrl: `${gcsBaseUrl}recommendations/Opatija_Hotel.jpg`, slug: "luxury-seaside-resort-opatija" },
